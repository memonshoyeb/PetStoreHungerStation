...
import static com.hunger.shoyeb.petAPI.Utilities.core.Global.Environment.ControlFileName;
...
//        String filePath = null;
        ...
        try {
            ...
            try {
               ...
               LOGGER.error( Common.getStackTrace(fx));
            }
