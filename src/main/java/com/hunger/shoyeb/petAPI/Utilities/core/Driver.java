package com.hunger.shoyeb.petAPI.Utilities.core;
...
public class Driver {
    ...
    private static void BrowserLanuch(String sBrowser, String sURL) {
        try {
            ...
            System.out.println("\n\n Open Browser Error <<<" + Common.getStackTrace(ex) + ">>>");
    ...
    public static void EnvironmentInitialize(String RunEnvironment) {
        ...
        try {
            ...
            System.out.println("\n\n Start Test Application Failed For Error <<<" + Common.getStackTrace(ex) + ">>>");
    ...
    public static List<XmlSuite> buildTestNgSuite(Hashtable<Integer, Hashtable<String, String>> driverTable) {
        ...
        try {
            ...
            try {
                xmlSuite.addListener("com.hunger.shoyeb.petAPI.Utilities.listeners.invokeMethodListener");
                xmlSuite.addListener("com.hunger.shoyeb.petAPI.Utilities.listeners.ITestListenerReporter");
    ...
    public static int runTestNgSuite(List<XmlSuite> suitList) {
        ...
        try {
            ...
            System.out.println(Common.getStackTrace(ex));
    ...
    public static Integer ExecuteTestSuite() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.println("\t\t Driver Error <<<" + Common.getStackTrace(ex)+ ">>>");
            System.out.println("\n\n ========= END OF EXEC ========= Exit Code [1] =========");
