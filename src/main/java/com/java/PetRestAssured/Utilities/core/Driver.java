...
public class Driver {
    ...
    public static List<XmlSuite> buildTestNgSuite(Hashtable<Integer, Hashtable<String, String>> driverTable) {
        ...
        try {
            ...
            try {
                xmlSuite.addListener("com.java.PetRestAssured.Utilities.listeners.invokeMethodListener");
                xmlSuite.addListener("com.java.PetRestAssured.Utilities.listeners.ITestListenerReporter");
