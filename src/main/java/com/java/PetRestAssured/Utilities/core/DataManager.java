package com.java.PetRestAssured.Utilities.core;
...
import static com.java.PetRestAssured.Utilities.core.Common.getStackTrace;
import static com.java.PetRestAssured.Utilities.core.Global.Environment.ControlFileName;
...
public class DataManager {
    ...
    public static String getPropertyFile(String prptString) {
        ...
        try {
            ...
            props.load(new FileReader(System.getProperty("user.dir")+"\\src\\main\\resources\\config.properties"));
